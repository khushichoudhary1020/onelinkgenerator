        ...
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              placeholder="https://fb.com/kushimanent"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://twitter.com/priyemporary2"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://instagram.com/kushimanent"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://github.com/khushichoudhary1020"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://t.me/khushichoudhary1020"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://www.linkedin.com/in/khushi-choudhary-a6b781226/"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="khushichoudhary1020@gmail.com"
            />
          </div>
        </div>
        <div>
          ...
          <div class="mt-1 flex rounded-md shadow-sm">
            ...
            <input
              ...
              class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              placeholder="https://youtube.com/khushichoudhary1020"
            />
          </div>
        </div>
        <div>
